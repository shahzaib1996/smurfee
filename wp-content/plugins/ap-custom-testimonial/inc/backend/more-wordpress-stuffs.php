<div class="about-ap_custom_testimonial-wrapper clearfix" id="apct-more-wordpress-resources-inner">
    <div class="about-desc-wrap clearfix">
        <div class="about-content">
            <div class="about-title-content">
                <div class="apct-title"><?php _e('More WordPress Resources', 'ap-custom-testimonial'); ?></div>
            </div>
            <div>
                <p> Themes Compatible with the Plugin :</p>

                <p><strong>Ap Custom Testimonial </strong> works best with every WordPress theme. It's even more remarkable when used with popular themes like VMagazine and AccessPress Parallax.</p>
