...
<div class="wrap">
    ...
    <h2 class="nav-tab-wrapper">                             
        ...
        <a href="javascript:void(0)" id="apct-more-wordpress-resources" class="apct-tabs-trigger nav-tab"><?php _e('More WordPress Stuffs', 'ap-custom-testimonial'); ?></a>
                        ...
                        <div class="apct-backend-wrapper clearfix" id="col-container">
                            <div class="apct-form-wraper">
                                <div class="inside">
                                    ...
                                    <!-- More WordPress Resources page -->
                                    <div class='apct-tab-contents' id='tab-apct-more-wordpress-resources' style="display:none">
                                        <?php include( 'more-wordpress-stuffs.php' ); ?>
                                    </div>
                                </div><!-- .inside -->
